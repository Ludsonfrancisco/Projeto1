...
<script src="../lib/jquery/JQUERY%20Main.js"></script>
...
<section>
    ...
    <button type="button" id="btn-destaque-prev" class="pull-left destaque-prev"><i class="fa fa-angle-left"></i></button>
    <button type="button" id="btn-destaque-next" class="pull-right destaque-next"><i class="fa fa-angle-right"></i></button>
    </div>
</section>
